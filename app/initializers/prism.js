	...
	initialize(_instance) {
		if (Prism) {
			Prism.languages.surql = {
				...
				variable: /[$][\w.]+/,
				function:
					/\b(?:fn|function|count|(?:(array|crypto|fn|geo|http|is|math|meta|parse|rand|session|sleep|string|time|type)::[\w]+)(::[\w]+)?)(?=\s*\()/i,
				...
				operator:
					/==|!=|\*=|\?=|=|!~|\*~|\?~|~|<=|<|>=|>|\+|-|\*|×|∙|\/|÷|∋|∌|∈|∉|⊇|⊃|⊅|⊆|⊂|⊄|&&|\|\||\b(?:AND|OR|IS NOT|IS|CONTAINSALL|CONTAINSANY|CONTAINSNONE|CONTAINSSOME|CONTAINSNOT|CONTAINS|ALLINSIDE|ANYINSIDE|NONEINSIDE|SOMEINSIDE|NOTINSIDE|INSIDE|OUTSIDE|INTERSECTS)\b/i,
				connector: /[.]|<->|<-|->/,
